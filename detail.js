...
function fetchData(data) {
    ...
    */
    ...
    img.src = "FishEyes_Photos/Sample_Photos/Photographers_ID_Photos/" + pg.getP_portrait();
    ...
    for (pgmd in pgmdList) {
        ...
        if (typeof md.getM_image() == 'undefined' && typeof md.getM_video() != 'undefined') {
            ...
            */
            ...
            source.setAttribute("src", "FishEyes_Photos/Sample_Photos/" + dirName + "/" + md.getM_video());
            ...
            console.log("Le média est de type image");
            var img = document.createElement("img");       
            img.src = "FishEyes_Photos/Sample_Photos/" + dirName + "/" + md.getM_image();
